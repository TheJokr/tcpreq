...
| [Rsrvd - Reserved](https://tools.ietf.org/html/draft-ietf-tcpm-rfc793bis-16#page-7): Must be zero in generated segments and must be ignored in received segments | ✔ | ✔ | [`reserved.py`](tcpreq/tests/reserved.py) |
